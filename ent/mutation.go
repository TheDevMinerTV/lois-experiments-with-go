...
func (m *TodoMutation) SetItem(s string) {
	m.item = &s
}

// Item returns the value of the "item" field in the mutation.
func (m *TodoMutation) Item() (r string, exists bool) {
	v := m.item
	if v == nil {
		return
	}
...
// OldItem returns the old "item" field's value of the Todo entity.
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldItem(ctx context.Context) (v string, err error) {
...
func (m *TodoMutation) Fields() []string {
	...
	if m.item != nil {
		fields = append(fields, todo.FieldItem)
	}
	if m._done != nil {
