...
func (tu *TodoUpdate) SetItem(s string) *TodoUpdate {
	tu.mutation.SetItem(s)
	return tu
}

// SetNillableItem sets the "item" field if the given value is not nil.
func (tu *TodoUpdate) SetNillableItem(s *string) *TodoUpdate {
	if s != nil {
		tu.SetItem(*s)
	}
	return tu
...
func (tu *TodoUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.Item(); ok {
		_spec.SetField(todo.FieldItem, field.TypeString, value)
	}
...
// SetItem sets the "item" field.
func (tuo *TodoUpdateOne) SetItem(s string) *TodoUpdateOne {
	tuo.mutation.SetItem(s)
	return tuo
}

// SetNillableItem sets the "item" field if the given value is not nil.
func (tuo *TodoUpdateOne) SetNillableItem(s *string) *TodoUpdateOne {
	if s != nil {
		tuo.SetItem(*s)
	}
	return tuo
...
func (tuo *TodoUpdateOne) sqlSave(ctx context.Context) (_node *Todo, err error) {
	...
	if value, ok := tuo.mutation.Item(); ok {
		_spec.SetField(todo.FieldItem, field.TypeString, value)
	}
